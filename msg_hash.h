...
enum msg_hash_enums
{
   ...
   MENU_LABEL(INPUT_SENSOR_ACCELEROMETER_ORIENTATION),
   MENU_LABEL(INPUT_SENSOR_GYROSCOPE_SENSITIVITY),
   MENU_LABEL(SENSOR_ACCELEROMETER_OFFSET_X),
   MENU_LABEL(SENSOR_ACCELEROMETER_OFFSET_Y),
   MENU_LABEL(SENSOR_ACCELEROMETER_OFFSET_Z),
   MENU_LABEL(SENSOR_GYROSCOPE_OFFSET_X),
   MENU_LABEL(SENSOR_GYROSCOPE_OFFSET_Y),
   MENU_LABEL(SENSOR_GYROSCOPE_OFFSET_Z),
   ...
   MENU_LABEL(SENSOR_ACCELEROMETER_CALIBRATE),
   MENU_LABEL(SENSOR_GYROSCOPE_CALIBRATE),
